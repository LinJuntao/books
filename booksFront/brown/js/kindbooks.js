var kinds = new Vue({
    ...
    methods: {
        kindChange() {
            ...
            let _bm = this;
            $.ajax({
                url: "http://localhost:9090/showData/" + _bm.radio,
                method: "POST",
                data: {},
        ...
        downBook: function (kindid, id) {
            let _om = this;
            $.ajax({
                url: "http://localhost:9090/downloadBookOne",
                method: "POST",
                data: {
                    kindid: kindid,
                    id: id
        ...
        btnCollcetion: function (kindid, id) {
            let _vm = this;
            $.ajax({
                url: "http://localhost:9090/collection_add",
                method: "POST",
                data: {
        ...
        btnShopping: function (kindid, id) {
            let _vm = this;
            $.ajax({
                url: "http://localhost:9090/shopping_add",
                method: "POST",
                data: {
    ...
    created() {
        ...
        let _vm = this;
        $.ajax({
            url: "http://localhost:9090/showData/" + _vm.radio,
            method: "POST",
            data: {},
            success: function (edata) {
