 var kindli = new Vue({
     ...
     mounted: function () {
         ...
         for (let i = 0; i < that.lis.length; i++) {
             $.ajax({
                 url: "http://120.78.75.213:8080/books/allBooksLink/" + (i + 1),
                 method: "POST",
                 async: false,
                 success: function (e) {
                     lists[i] = e;
 ...
 var newslistId = new Vue({
     ...
     methods: {
         morelistNew: function () {
             let that = this;
             $.ajax({
                 url: "http://120.78.75.213:8080/books/newBooksLink/1",
                 method: "POST",
                 success: function (e) {
     ...
     created() {
         let _vm = this;
         $.ajax({
             url: "http://120.78.75.213:8080/books/newBooksLink/0",
             method: "POST",
             success: function (e) {
                 _vm.newlists = e;
                 //  console.log(e)
 ...
 var quitelist = new Vue({
     ...
     methods: {
         morelistQuite: function () {
             let that = this;
             $.ajax({
                 url: "http://120.78.75.213:8080/books/newsLink/2",
                 method: "POST",
                 success: function (e) {
     ...
     created() {
         let _vm = this;
         $.ajax({
             url: "http://120.78.75.213:8080/books/newsLink/1",
             method: "POST",
             success: function (e) {
                 _vm.quitelists = e;
                 //  console.log(e)
